...
- [Rを用いたデータ解析の基礎](/slides/tohoku2026r/) 2026-04 東北大学
  (学部3年生向け進化学実習の一部)
...
- [Rを用いたデータ解析の基礎と応用](https://comicalcommet.github.io/r-training-2025/)
  ...
  [**よくあるエラー集**](https://comicalcommet.github.io/r-training-2025/R_training_2025_7.html)が特に重宝。
...
: [RユーザのためのRStudio[実践]入門](https://amzn.to/2Yy5LND) 松村ら 2021
